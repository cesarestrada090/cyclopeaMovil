 ...
 * @author KACESE
 */
public class ListarCertificadosAnulacion extends javax.swing.JInternalFrame {
    ...
    public ListarCertificadosAnulacion() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnBuscar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMAGENES/Botones/deleteusuario.png"))); // NOI18N
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        if (!x.toString().equals("")) {
            CertificadoBL CertBL=new CertificadoBL();
            CertBL.anularCertificado(idInforme);
            JOptionPane.showMessageDialog(null, "Certificado Anulado Correctmente", "", 1);
            dispose();
        } else {
    ...
    private void jTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable2MouseClicked
        ...
        idInforme = Integer.parseInt(jTable2.getValueAt(jTable2.getSelectedRow(), indX1).toString());
