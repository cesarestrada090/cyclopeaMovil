...
/**
 * The Class ProcesoMAVAsignacionReemplazoGerenteRegionAction.
 *
...
@ManagedBean
@SessionScoped
public class ProcesoMAVAsignacionReemplazoGerenteRegionAction extends BaseProcesoAbstractAction {

	private static final long serialVersionUID = 8218479946715585658L;
	...
	protected BaseProcesoForm devuelveFormProceso() throws Exception {
		ProcesoMAVAsignacionReemplazoGerenteRegionForm form = new ProcesoMAVAsignacionReemplazoGerenteRegionForm();
		return form;
	}
	...
	protected void setViewAtributes() throws Exception {
		...
		ProcesoMAVAsignacionReemplazoGerenteRegionForm f = (ProcesoMAVAsignacionReemplazoGerenteRegionForm) this.formProceso;
	...
	public void findAttributes(ActionEvent event) throws Exception {
        ...
        this.mavGerentesList = service.getGerentesRegiones(criteria);
	...
	public void grabar(ActionEvent event) {
		...
		if(this.selectGerente == null) {
			...
			if(f.getCodigoClienteBuscar() != null && !f.getCodigoClienteBuscar().isEmpty()) {				
				...
				this.addInfo("Info: ", this.getResourceMessage("procesoMAVAsignacionReemplazoGerenteRegionForm.msg.clienteNoIngresado"));
			}
		}		
	}
	...
	protected Map<String, Object> executeProcess(Map<String, Object> params) throws Exception {
		...
		try {
			...
			String codigoRegion = (String) this.selectGerente.get("codigoRegion");
			...
			if(!existeCliente) {
				this.addInfo("Info: ", this.getResourceMessage("procesoMAVAsignacionReemplazoGerenteRegionForm.msg.clienteNoExiste",
									   new Object[]{f.getCodigoClienteBuscar()}));
			} else {		        
				//ejecutamos la asignacion del gerente a la region
				service.executeAsignacionGerenteRegion(params);
				
				if(f.getCodigoClienteBuscar().equals("")) {
					this.addInfo("Info: ", this.getResourceMessage("procesoMAVAsignacionReemplazoGerenteRegionForm.msg.deasignacionCorrecta", 
										  new Object[]{codigoRegion}));
				} else {
					String[] datos = new String[] {f.getCodigoClienteBuscar(), codigoRegion};
					this.addInfo("Info: ", this.getResourceMessage("procesoMAVAsignacionReemplazoGerenteRegionForm.msg.asignacionCorrecta", datos));
				}
